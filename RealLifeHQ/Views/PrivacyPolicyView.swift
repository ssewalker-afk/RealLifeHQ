        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                SectionView(title: "Introduction") {
                    ...
                    HighlightBox(text: "Your privacy is paramount to us. All data created and stored within RealLifeHQ remains exclusively on your device. We do not collect, transmit, store, or share any of your personal data with third parties or our servers.")
                }
                ...
                SectionView(title: "Information We Collect") {
                    ...
                    DataTypeCard(title: "Vault Items (Secure Storage)", items: [
                        ...
                        "Usernames and passwords (stored locally)",
                        "Website URLs and notes",
                ...
                SectionView(title: "Data Security") {
                    ...
                    SecurityFeature(title: "Local Storage Security", description: "All data is stored using iOS's secure storage mechanisms. Vault passwords and sensitive information remain on your device.")
                    
                    SecurityFeature(title: "Biometric Protection", description: "Optional Face ID/Touch ID protection for the Vault feature, leveraging iOS's secure biometric authentication system.")
                    
                    SecurityFeature(title: "iOS Sandbox", description: "The app operates within iOS's secure app sandbox. Data is isolated from other apps and protected by iOS security features.")
                }
                ...
                SectionView(title: "Third-Party Services") {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        BulletPoint(text: "App Store (managed by Apple)")
                    }
                }
                ...
                // Footer
                Text("Effective Date: This privacy policy is effective as of January 25, 2026 and applies to all users of RealLifeHQ.")
                    .font(.caption)
                    .foregroundColor(.secondary)
